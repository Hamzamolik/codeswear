        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
              ...
              <h1 className="text-gray-900 text-3xl title-font font-medium mb-4">Oder Id: 877514 </h1>
              <p className="leading-relaxed mb-4">Your order has been sucessed.</p>
              ...
              <div className="flex border-t border-gray-200 py-2">
                <span className="text-gray-500">Wear th code(XL/Black)</span>
